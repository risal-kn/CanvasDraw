package com.kn.risal.canvasdraw.DrawView;
...
public class ActivityBase extends Activity
{
    ...
    public static final String EVENT_COLOR_BEAR = "Color bear";
    public static final String EVENT_COLOR_PARROT = "Color parrot";
    public static final String EVENT_COLOR_TORTOISE = "Color tortoise";
    public static final String EVENT_COLOR_MIX = "Color mix";
    public static final String EVENT_OPEN_COLORS = "Open colors";
    public static final String EVENT_OPEN_INFO = "Open info";
    public static final String EVENT_CLICK_LINK = "Click link";
